...
export class Context {
	...
	constructor() {
		...
		this.engineSchemas.set(
			EngineMessage.ConnectionAttempt,
			connectionAttemptSchema,
		);
		this.engineSchemas.set(
			EngineMessage.ConnectionAccepted,
			connectionAcceptedSchema,
		);
		this.engineSchemas.set(
			EngineMessage.ConnectionDenied,
			connectionDeniedSchema,
		);
		this.engineSchemas.set(
			EngineMessage.ConnectionTerminated,
			connectionTerminatedSchema,
		);
